...
import static captureofficers.ui.ViewPrisonersUI.PRISONER_ROW_SIZE;
...
public class PrisonersPanelCreatorPlugin implements InteractionDialogPlugin {
    ...
    public void init(InteractionDialogAPI dialog) {
        ...
        float screenWidth = Math.max(Display.getWidth(), 1280);
        float screenHeight = Math.max(Display.getHeight(), 768);
