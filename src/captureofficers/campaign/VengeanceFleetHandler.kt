...
object VengeanceFleetHandler {
    ...
    fun addVengeancePoint(factionId: String) {
        ...
        var factionConfig = FactionConfigLoader.getFactionConfig(factionId)
    ...
    fun spawnVengeanceFleet(factionId: String, factionConfig: FactionConfig?): CampaignFleetAPI {
