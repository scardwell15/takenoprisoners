...
public class CaptureOfficers extends BaseModPlugin {
    private static final Logger log = Logger.getLogger(CaptureOfficers.class);
    private CampaignListener listener = null;
